/* Group Names: Kent R. Grefiel, Rainiel Codoy
...
int main() {
	...
	case 'b':
		...
		do {
			...
			if (payment >= (set2 * quantity)) { // Check if payment is sufficient
				...
				cout << fixed << showpoint << setprecision(2);
				cout << "\n\t\t\tYour change is :P" << balance << endl; // Display change
			} else {
				cout << "\a"; // Alert for insufficient payment
				cout << "\n\t\t\t\033[31mPayment not enough\033[0m"; // Error message
			}
		...
		if (receipt == 'Y' || receipt == 'y') {
			...
			cout << "\t\t\t| Description      Qty      Price      Amount    |" << endl;
			cout << "\t\t\t ------------------------------------------------" << endl;
			cout << "\t\t\t  Set B " << "   	    " << quantity << " 	   " << set1 << "      " << set1 * quantity << "	   " << endl; // Receipt details
			cout << "                                                " << endl;
			cout << "\t\t\t  Total " << "                              " << set1 * quantity << endl; // Total amount
			cout << "\t\t\t  Cash " << "                               " << payment << endl; // Payment information
			cout << "\t\t\t  Balance " << "                            " << balance << endl; // Balance
	...
	case 'c':
		...
		if (receipt == 'Y' || receipt == 'y') {
			...
			cout << "\t\t\t| Description      Qty     Price      Amount     |" << endl;
			cout << "\t\t\t ------------------------------------------------" << endl;
			cout << "\t\t\t  Set C " << "   	    " << quantity << " 	   " << set1 << "      " << set1 * quantity << "	   " << endl; // Receipt details
			cout << "                                                " << endl;
			cout << "\t\t\t  Total " << "                              " << set1 * quantity << endl; // Total amount
			cout << "\t\t\t  Cash " << "                               " << payment << endl; // Payment information
			cout << "\t\t\t  Balance " << "                            " << balance << endl; // Balance
	...
	case 'd':
		...
		if (receipt == 'Y' || receipt == 'y') {
			...
			cout << "\t\t\t| Description      Qty     Price      Amount     |" << endl;
			cout << "\t\t\t ------------------------------------------------" << endl;
			cout << "\t\t\t  Set D " << "   	    " << quantity << " 	   " << set1 << "      " << set1 * quantity << "	   " << endl; // Receipt details
			cout << "                                                " << endl;
			cout << "\t\t\t  Total " << "                              " << set1 * quantity << endl; // Total amount
			cout << "\t\t\t  Cash " << "                               " << payment << endl; // Payment information
			cout << "\t\t\t  Balance " << "                            " << balance << endl; // Balance
	...
	case 'e':
		...
		if (receipt == 'Y' || receipt == 'y') {
			...
			cout << "\t\t\t| Description      Qty     Price      Amount     |" << endl;
			cout << "\t\t\t ------------------------------------------------" << endl;
			cout << "\t\t\t  Set E " << "   	   " << quantity << " 	   " << set1 << "     " << set1 * quantity << "	  " << endl; // Receipt details
			cout << "                                                " << endl;
			cout << "\t\t\t  Total " << "                              " << set1 * quantity << endl; // Total amount
			cout << "\t\t\t  Cash " << "                               " << payment << endl; // Payment information
			cout << "\t\t\t  Balance " << "                            " << balance << endl; // Balance
	...
	case 'f':
		...
		if (receipt == 'Y' || receipt == 'y') {
			...
			cout << "\t\t\t| Description      Qty     Price      Amount     |" << endl;
			cout << "\t\t\t ------------------------------------------------" << endl;
			cout << "\t\t\t  Set F " << "   	   " << quantity << " 	   " << set1 << "     " << set1 * quantity << "	  " << endl; // Receipt details
			cout << "                                                " << endl;
			cout << "\t\t\t  Total " << "                              " << set1 * quantity << endl; // Total amount
			cout << "\t\t\t  Cash " << "                               " << payment << endl; // Payment information
			cout << "\t\t\t  Balance " << "                            " << balance << endl; // Balance
